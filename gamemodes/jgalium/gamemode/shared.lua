...
include( "player_class/player_gamemode.lua" )
...
function GM:PreGamemodeLoaded()
    team.SetUp(TEAM_JUDGE, "Prisoner", Color(255, 255, 255), false)
    team.SetUp(TEAM_OP, "Guard", Color(0, 0, 255), false)
	team.SetUp(TEAM_PO, "Guard", Color(255, 0, 0), false)
